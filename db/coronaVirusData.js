...
const fs = require("fs");
const cases = require("./coronaVirusModel");

// site to scrape
const caseSite = "https://github.com/CSSEGISandData/COVID-19/blob/master/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Confirmed.csv"
